---
id: esG7-03-01-cluster
slug: /krEsguide7/esG7-03-01-cluster
title: "3.1 클러스터 구성"
...
date: 2022-01-25"
tags: ['system', 'architecture', 'cluster']
---
...
![각 서버에서 노드 실행](../assets/03-01_cluster_1.png)
...
![한 서버에서 여러 노드 실행](../assets/03-01_cluster_2.png)
...
![하나의 물리 서버에서 서로 다른 두 개의 클러스터 실행](../assets/03-01_cluster_3.png)
...
![디스커버리 과정](../assets/03-01_cluster_discovery.png)
