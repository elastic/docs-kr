---
id: esG7-02-02-01-download
slug: /krEsguide7/esG7-02-02-01-download
title: "2.2.1 다운로드 설치 및 실행"
...
Elasticsearch 실행을 위해서는 자바1.8 이상의 버전이 설치되어 있어야 하며 JAVA_HOME 환경변수가 잡혀있어야 합니다. 각 버전별로 필요한 자바 버전은 [https://www.elastic.co/support/matrix#matrix_jvm](https://www.elastic.co/support/matrix#matrix_jvm) 페이지에서 확인이 가능합니다.
...
<DocTabs>
  <DocTab name="<start.sh> 파일의 내용">
```text
bin/elasticsearch -d -p es.pid
```
  </DocTab>
  <DocTab name="<stop.sh> 파일의 내용">
```text
kill `cat es.pid`
```
  </DocTab>
