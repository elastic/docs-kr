---
id: esG7-05-05-exact-value
slug: /krEsguide7/esG7-05-05-exact-value
title: "5.5 정확값 쿼리 - Exact Value Query"
...
bool 쿼리의 filter 안에 하위 쿼리를 사용하면 스코어에 영향을 주지 않습니다. 다음 3개의 검색 결과를 비교 해 보도록 하겠습니다.
